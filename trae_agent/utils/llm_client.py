...
from .base_client import LLMMessage, LLMResponse, BaseLLMClient
...
class LLMClient:
    ...
    def chat(self, messages: list[LLMMessage], model_parameters: ModelParameters, tools: list[Tool] | None = None) -> LLMResponse:
